...
int minex();
int maxsal();
void Print(CV*, CV*, CV*, CV*, string, int, int);//The this function actions have been using the all the CV type objects and variables, which have been declared in the "main" function.
